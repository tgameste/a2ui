...
async def generate_flashcards(
    ...
    if topic and _HAS_OPENSTAX:
        ...
        try:
            ...
            logger.info(
                f"OpenStax: matched {len(matched_chapters)} chapters,"
                f" {len(openstax_content)} chars"
            )
                    ...
                    },
                    {
                        ...
                        "component": {
                            "Text": {
                                "text": {
                                    "literalString": (
                                        "ATP & Chemical Stability: Correcting the"
                                        " Misconception"
                                    )
                                },
                                "usageHint": "h3",
                    ...
                    },
                    {
                        ...
                        "component": {
                            "AudioPlayer": {
                                ...
                                "audioDescription": {
                                    "literalString": (
                                        "A personalized podcast about ATP and chemical"
                                        " stability"
                                    )
                                },
                            }
                    ...
                    },
                    {
                        ...
                        "component": {
                            "Text": {
                                "text": {
                                    "literalString": (
                                        "This personalized podcast explains why 'energy"
                                        " stored in bonds' is a common misconception."
                                        " Using your preferred gym analogies, it walks"
                                        " through how ATP hydrolysis actually releases"
                                        " energy through stability differences, not"
                                        " bond breaking. Perfect for your MCAT prep!"
                                    )
                                },
                                "usageHint": "body",
                            }
                    ...
                    },
                    {
                        ...
                        "component": {
                            "Text": {
                                "text": {
                                    "literalString": (
                                        "Visual Guide: ATP Energy & Stability"
                                    )
                                },
                                "usageHint": "h3",
                            }
                    ...
                    },
                    {
                        ...
                        "component": {
                            "Text": {
                                "text": {
                                    "literalString": (
                                        "This animated explainer uses the compressed"
                                        " spring analogy to show why ATP releases"
                                        " energy. See how electrostatic repulsion in"
                                        " ATP makes it 'want' to become the more stable"
                                        " ADP + Pi."
                                    )
                                },
                                "usageHint": "body",
...
async def _generate_a2ui_content(
    ...
    if not project:
        ...
        return {
            "error": (
                "GOOGLE_CLOUD_PROJECT not configured. Set it in environment or"
                " deploy.py."
            )
        }
...
app = App(root_agent=root_agent, name="personalized_learning")
