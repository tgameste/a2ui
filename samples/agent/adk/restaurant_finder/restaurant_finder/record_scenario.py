...
async def main():
    ...
    if search_messages:
        ...
        save_messages_with_image_copies(
            search_messages, image_base_url, search_out_path
        )
        ...
        if first_restaurant:
            ...
            if booking_messages:
                booking_out_path = os.path.join(
                    dojo_data_dir, "restaurant-booking.json"
                )
                save_messages_with_image_copies(
            ...
            confirmation_query = (
                ...
                f" {dietary_reqs}. The imageURL is {image_url}"
            )
